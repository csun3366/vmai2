...
def initModels():
    ...
    # Add models  
    models["58"] = Svc(net_g_path='logs/44k/G_han_30000.pth', config_path='configs/config_han.json', device=device, cluster_model_path='logs/44k/kmeans_10000.pt')
    models["57"] = Svc(net_g_path='logs/44k/G_wang_2000.pth', config_path='configs/config_wang.json', device=device, cluster_model_path='logs/44k/kmeans_10000.pt')
...
os.chdir('/home/csun3366/vmai/app/sovits')
